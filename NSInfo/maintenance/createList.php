...
class CreateList extends Maintenance
{
	...
	public function execute()
	{
		...
		if ($nsList->exists()) {
			$this->output('WARNING - current list is being overwritten. You may revert ' . self::NSLIST . " as normal if this was not what was intended.\n\n");
		}
